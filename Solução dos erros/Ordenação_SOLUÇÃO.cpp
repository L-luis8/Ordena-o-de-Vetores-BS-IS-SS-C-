...
int main(){
    ...
    /*
                PROPOSTA DE SOLUÇÃO
        -----------------------------------
        Na linha 85 - Retirava esse 'do, while';
        Na linha 103 - A chamada da função preencheVetor seria antes
            pois seria gerado apenas uma vez para a ordenação dos vetores IGUAIS;
        Na linha 105 - O FOR precisaria ser rodado apenas uma vez, a opção de 100
            rodar mais de uma vez, seria desnecessário;
    */
    ...
    int *vetor = new int[tam];
        ...
        for(int i = 0; i < 100; i++){ //Aqui eu deveria colocar pra rodar só uma vez, no meu pensamento;
